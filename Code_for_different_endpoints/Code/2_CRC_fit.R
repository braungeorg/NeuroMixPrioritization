...
list.of.packages <- c("dplyr","drc","tcpl","EnvStats","data.table","stringr")
...
#Import your effect and/or viability data
Data <- fread("Input/raw_assay_data.csv")
...
data.table::fwrite(Activitydata_fit,"Input/fitted_assay_data.csv")
